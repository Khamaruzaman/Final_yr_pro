...
def process_videos(videos, detector_cls: Type[VideoFaceDetector], selected_dataset, opt):
    ...
    loader = DataLoader(dataset, shuffle=False, num_workers=opt.processes, batch_size=1, collate_fn=collate_fn_identity)
    missed_videos = []
...
def main():
    ...
    parser.add_argument('--data_path', default='test\\YouTube-real', type=str,
